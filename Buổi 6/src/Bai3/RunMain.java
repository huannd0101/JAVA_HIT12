...
public class RunMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------K15: " + totalK(lopHoc, 15));
    ...
    private static int totalK(LopHoc lopHoc, int khoaHoc) {
        int cnt = 0;
        for (SinhVien sinhVien : lopHoc.getX()) {
    ...
    private static void sort(LopHoc lopHoc) {
